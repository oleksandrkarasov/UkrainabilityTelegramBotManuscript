...
`english_data_for_sharing.xlsx` contains anonymised, translated dataset without spatiotemporal columns, which can be used to reproduce statistical analysis and modelling.
